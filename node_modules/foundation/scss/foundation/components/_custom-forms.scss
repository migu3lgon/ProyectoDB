...
$custom-select-height : emCalc(13px)+(emCalc(16px) * 1.5) !default;
    ...
    form.custom {
        .custom.dropdown {
            ...
            .current {
                ...
                overflow: hidden;
                display: block;
                margin-#{$default-float}: emCalc(16px) / 2;
                margin-#{$opposite-direction}: $custom-select-height;
            }
            .selector {
                cursor: default;
                position: absolute;
                width: emCalc(16px) * 2.5;
                height: $custom-select-height;
                display: block;
                ...
                &:after {
                    ...
                    position: absolute;
                    #{$default-float}: (emCalc(16px) * 2.5) / 2 - emCalc(5px);
                    top: 50%;
                    margin-top: -3px;
                }
            }
