...
$input-error-message-top: - (emCalc(16px)) - emCalc(5px) !default;
...
@mixin form-row-base {
    .row {
        margin: 0 ((-emCalc(16px)) / 2);
        .column,
        .columns {
            padding: 0 emCalc(16px) / 2;
        }
    ...
    textarea.column,
    textarea.columns {
        padding-#{$default-float}: emCalc(16px) / 2;
    }
}
...
@mixin form-element() {
    ...
    margin: 0 0 emCalc(16px) 0;
    padding: emCalc(16px) / 2;
    height: emCalc(13px)+(emCalc(16px) * 1.5);
    width: 100%;
...
@mixin form-label($alignment:false, $base-style:true) {
    ...
    @else if $alignment==inline {
        margin: 0 0 emCalc(16px) 0;
        padding: emCalc(16px) / 2 + emCalc($input-border-width * 2) 0;
    }
}
...
@mixin prefix-postfix-base {
    ...
    font-size: emCalc(14px);
    height: (emCalc(14px) + (emCalc(16px) * 1.5) - emCalc(1px));
    line-height: (emCalc(14px) + (emCalc(16px) * 1.5) - emCalc(1px));
}
